...
VirtDBDataProvider = (function() {
  function VirtDBDataProvider(name1, connectionString) {
    this.name = name1;
    ...
    this.createReply = bind(this.createReply, this);
  ...
  VirtDBDataProvider.FieldTypeDetector = require("./fieldTypeDetector");
